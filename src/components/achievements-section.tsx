...
const achievements = [
  {
    ...
    description: "Spearheaded embedded software development for NASA's Orion spacecraft display unit using Wind River Simics virtualization",
  ...
  },
  {
    ...
    description: "Led virtualization of International Space Station Multiplexor/Demultiplexer (MDM) test equipment using Unix and Linux systems",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          {achievements.map((achievement, index) => (
            <Card key={index} className="bg-gradient-to-br from-primary/5 to-primary/10 border-primary/20 hover:border-primary/40 transition-all duration-300">
              <CardHeader>
        ...
        <Alert className="bg-primary/5 border-primary/20">
          ...
          <AlertDescription className="text-sm">
            <strong>Recognition:</strong> These achievements demonstrate expertise in mission-critical 
            software development, cost optimization, and innovation in aerospace technology. 
            The work contributed directly to advancing human space exploration capabilities.
          </AlertDescription>
        </Alert>
      </div>
    </section>
